...
const SAMPLE_CARDS: ReviewCard[] = [
  {
    ...
    choices: [
      ...
      'イ．TCPは信頼性の高いデータ転送を保証するが、UDPは保証しない',
      'ウ．UDPはフロー制御機能を持つが、TCPは持たない',
      'エ．TCPはリアルタイム通信に適し、UDPは大容量転送に適する',
    ],
    answer: 1,
  ...
  },
  {
    ...
    choices: [
      'ア．暗号化と復号に同じ鍵を使用する',
      'イ．送信者が受信者の公開鍵で暗号化し、受信者が秘密鍵で復号する',
      'ウ．鍵の配送問題が共通鍵暗号より深刻である',
      'エ．処理速度が共通鍵暗号より速い',
    ],
    answer: 1,
  ...
  },
  {
    ...
    choices: ['ア．O(n)', 'イ．O(n log n)', 'ウ．O(n²)', 'エ．O(log n)'],
    answer: 2,
